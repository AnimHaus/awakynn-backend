...
from app.routers import auth, classes, contact, events as events_router, gallery as gallery_router, orders, products, settings as settings_router, uploads, webhooks
